...
<html lang="en">
    ...
    <body>
        ...
        <div class="container well">
            <div class="row">
                <div class="col-xs-12"><h3>Registrar Cliente</h3></div>
            </div>
            <br /><br />
            ...
            <form  class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <a href="prueba1.jsp"><button type="button" class="btn btn-danger btn-lg"><span class="glypicon glypicon-remove-circle"></span>Cancelar</button></a>	
